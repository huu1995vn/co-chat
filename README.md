...
1. Dừng máy chủ phát triển (nếu nó vẫn đang chạy) và chạy lệnh sau:
gatsby build
<!-- Khi điều này bắt đầu, bạn có thể xem trang web của mình tại http://localhost:9000. -->
2. Chạy
gatsby serve === npm run serve
